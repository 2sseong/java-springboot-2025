...
public class Spring04Application {
	...
	public static void main(String[] args) {
		...
		List<String> avengers= Arrays.asList("IronMan", "Captain America", "Spider Man", "Hulk", "AntMan");
		...
		// 단점은 출력시 반복문 써야하고, 정렬후 원본 순서가 사라짐
		System.out.println("스트림API");
		// 2. 스트림API	사용방식
		avengers = Arrays.asList("IronMan", "Captain America", "Spider Man", "Hulk", "AntMan");
