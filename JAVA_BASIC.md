...
- 연산자는 거의 대부분의 언어에서 동일하게 사용
    ...
    - [Java실습](./day01/spring01/src/main/java/com/lsh/spring01/Spring01Application.java)
...
- 조건(분기)문 : if문, switch문, 3항 연산
    ...
    - [Java문법실습](./day01/spring02/src/main/java/com/lsh/spring02/Spring02Application.java)
...
- 반복문: for문, while문, do-while문
    ...
    - [Java문법실습](./day01/spring03/src/main/java/com/lsh/spring03/Spring03Application.java)
...
- 반복제어 키워드: break, continue
    ...
    - [Java문법실습](./day02/spring01/src/main/java/com/lsh/spring01/Spring01Application.java)
...
- 배열에 사용할 메서드- Arrays 객체를 사용
    ...
    - copyOf() : 배열을 복사해서 새로운 배열로 변환
    - equals() : 두개의 배열이 동일한지 여부 판별
    - binarySearch() : 배열내 요소를 찾아서 인덱스를 변환

- Java 컬렉션 프레임 워크 - 배열을 좀 더 기능적으로 강화한 객체
    - **List**, Stack, Vector, ArrayList, HashSet, HashMap(파이썬 딕셔너리), HashTable

    - [Java문법실습](./day02/spring02/src/main/java/com/lsh/spring02/Spring02Application.java)
...
- 함수와 동일. 객체지향 언어에서는 함수를 메서드로 사용.
    ...
    - 메서드 오버로딩 - 동일한 메서드명에 파라미터가 다르게 선어
    - 가변인자(파라미터) - 파라미터 개수가 동적일 떄 사용

    - [Java문법실습](./day02/spring03/src/main/java/com/lsh/spring03/Spring03Application.java)

- **Static**
    - 프로그램 실행 후 클래스 인스턴스가 생성안됨
    - 이 상태에서 프로그램 엔트맆포인트 메서드는 바로 실행되어야 함
...
- 클래스 개요
    ...
    class NewCar{
        ...
        // 생성자함수(파이썬__init__와 유사) (클래스명과 일치해야함)
        NewCar(){
            model_name = "없음";
            company = "현대자동차";
...
- 인스턴스(instance)
    ...
    - [Java문법실습](./day02/spring04/src/main/java/com/lsh/spring04/Spring04Application.java)
...
- 특징
    ...
    - 동일한 부모클래스를 상속받은 모든 하위 자식클래스들은 타입이 호환된다
    ...
    ```
- [Java문법실습](./day02/spring05/src/main/java/com/lsh/spring05/Spring05Application.java)
...
- 접근제어자 분류
    ...
    - default : (키워드 생략가능)같은 패키지 내에서만 접근이 가능
...
- 캡슐화를 제대로 하기위한 코딩방법 
    ...
    ```java
    poppy.age = -19; //이런 현상을 막아야 함
    ```

    - 멤버변수는 private 접근제어자로 멤버변수 선언.
...
- 모든 클래스의 조상 클래스. extends를 사용하지 않아도 항상 상속됨.
    - java.lang.Object
    - Object 클래스가 갖고 있는 멤버변수와 메서드는 다 사용가능
...
- 인터페이스는 상속이라 부르지 않고 구현이라고 부름
    ...
    - 인터페이스를 implements로 가져오면 인터페이스 내의 추상메서드는 반드시 구현해야 함

- 스프링의 의존성 주입(Dependency Injection)의 핵심

- - [Java문법실습](./day03/spring01/src/main/java/com/lsh/spring01/Spring01Application.java)
...
- 에외 클래스 : ArithmeticException, ArrayIndexOutOfBoundsException
- 모든 예외클래스는 Exception 클래스를 상속받아서 생성
- 단순히 Exception 클래스로 예외처리해도 무방(무슨오류인지 모르면 Exception 사용)
...
- [Java문법실습](./day03/spring02/src/main/java/com/lsh/spring02/Spring02Application.java)
...
- [Java문법실습](./day03/spring04/src/main/java/com/lsh/spring04/Spring04Application.java)
...
- [Java문법실습](./day04/spring01/src/main/java/com/lsh/spring01/Spring01Application.java)
...
-[Java문법실습](./day04/spring02/src/main/java/com/lsh/spring02/Spring02Application.java)
...
-[Java문법실습](./day04/spring03/src/main/java/com/lsh/spring03/Spring03Application.java)
#### 람다식
...
- [Java문법실습](./day04/spring04/src/main/java/com/lsh/spring04/Spring04Application.java)
...
- [JAVA문법실습](./day05/spring01/src/main/java/com/lsh/spring01/Spring01Application.java)
...
- [JAVA문법실습](./day05/spring02/src/main/java/com/lsh/spring02/Spring02Application.java)


#### 어노테이션
- 한글로 주석이지만, #, //, /**/ 소스에 영향을 미치지 않는 주석과 다름
- 자바 소스에 추가해서 여러가지 기능을 수행하는 메타데이터 일종
- @로 시작, JDK1.5 이상부터 사용가능
- 클래스 파일에 같이 포함되어서 JVM 작동시 실행됨
...
<img src="./image/sb011.png" width ="700">
