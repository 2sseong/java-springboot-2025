...
public class Spring02Application {
	...
	public static void main(String[] args) throws IOException {
		...
		output.close();
		System.out.println("FileOutpuStream 파일 생성 완료!");
		...
		fw2.close();
		System.out.println("FileWriter추가생성 완료");
